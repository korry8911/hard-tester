...
static void test_parse_jepsen_etcd()
{
  ...
  assert(ostream.str() == "log info, number of entries: 20\n"
    "entry id: 0, thread id: " INIT_THREAD_ID ", call: read()\n"
    "entry id: 1, thread id: " INIT_THREAD_ID ", call: write(4)\n"
    "entry id: 0, thread id: " INIT_THREAD_ID ", return: read() : -1\n"
    "entry id: 1, thread id: " INIT_THREAD_ID ", return: write() : succeeded\n"
    "entry id: 2, thread id: " INIT_THREAD_ID ", call: write(3)\n"
    "entry id: 3, thread id: " INIT_THREAD_ID ", call: read()\n"
    "entry id: 3, thread id: " INIT_THREAD_ID ", return: read() : 3\n"
    "entry id: 2, thread id: " INIT_THREAD_ID ", return: write() : succeeded\n"
    "entry id: 4, thread id: " INIT_THREAD_ID ", call: cas(3, 0)\n"
    "entry id: 4, thread id: " INIT_THREAD_ID ", return: cas() : succeeded\n"
    "entry id: 5, thread id: " INIT_THREAD_ID ", call: cas(0, 3)\n"
    "entry id: 5, thread id: " INIT_THREAD_ID ", return: cas() : failed\n"
    "entry id: 6, thread id: " INIT_THREAD_ID ", call: write(2)\n"
    "entry id: 6, thread id: " INIT_THREAD_ID ", return: write() : succeeded\n"
    "entry id: 7, thread id: " INIT_THREAD_ID ", call: write(1)\n"
    "entry id: 8, thread id: " INIT_THREAD_ID ", call: cas(2, 1)\n"
    "entry id: 9, thread id: " INIT_THREAD_ID ", call: read()\n"
    "entry id: 9, thread id: " INIT_THREAD_ID ", return: read() : 3\n"
    "entry id: 7, thread id: " INIT_THREAD_ID ", return: write() : pending\n"
    "entry id: 8, thread id: " INIT_THREAD_ID ", return: cas() : pending\n");
...
static void jepsen_etcd_experiment()
{
  ...
  static constexpr char s_etcd_prefix[] = "logs/test_";
  ...
  for (bool expect : expected)
  {
    ...
    std::ifstream file;
    filename = s_etcd_prefix + std::to_string(i) + s_etcd_postfix;
    file.open(filename);
    assert(file.is_open());
